...
class MannerTableViewController: UITableViewController, MFMailComposeViewControllerDelegate {
...
//        NSUserDefaults.standardUserDefaults().removePersistentDomainForName(appDomain)
    ...
    func configuredMailComposeViewController() -> MFMailComposeViewController {
        ...
        mailComposerVC.setToRecipients([s.defaults.stringForKey("email")!])
        mailComposerVC.setSubject("Progress")
        mailComposerVC.setMessageBody("<p>I have viewed \(completedManners)</p>", isHTML: true)
    ...
    func showSendMailErrorAlert() {
        ...
        let sendMailErrorAlert = UIAlertController(title: "couldn't send email", message: "your device can't send email", preferredStyle: UIAlertControllerStyle.Alert)
